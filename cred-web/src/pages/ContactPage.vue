...
useHead({
    ...
    meta: [
        {
            name: "description",
            content: "Get in touch with the CredWave team.",
        },
            ...
            <section class="py-24 px-6">
                <div class="max-w-[1000px] mx-auto">
                    <div class="reveal text-center mb-16">
                        ...
                        <p
                            class="mt-3 text-text-secondary text-lg max-w-[460px] mx-auto"
                        >
                            Whether you're curious about features, pricing, or
                            just want to say hi — we're here.
                        </p>
                    </div>
                    ...
                    <div class="reveal grid md:grid-cols-5 gap-12">
                        ...
                        <div class="md:col-span-2 space-y-8">
                            <div>
                                <div
                                    class="w-10 h-10 rounded-xl bg-accent/8 flex items-center justify-center mb-3"
                                >
                                    <Mail class="w-5 h-5 text-accent" />
                                </div>
                                <p
                                    class="font-semibold text-text-primary text-sm"
                                >
                                    Email us
                                </p>
                                <a
                                    href="mailto:hello@credwave.app"
                        ...
                        <div class="md:col-span-3">
                            <div v-if="sent" class="text-center py-16">
                                <CheckCircle
                                    class="w-10 h-10 text-success mx-auto mb-4"
                                />
                                <p
                                    class="text-lg font-semibold font-display text-text-primary"
                                >
                                    Message sent
                                </p>
